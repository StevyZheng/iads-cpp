...
#ifndef IADS_TABLEFORMATTER_HPP
#define IADS_TABLEFORMATTER_HPP
...
namespace tableformatter{
    ...
    namespace internal{
        inline void throw_error(bool statement, const std::string& message){
            if (!statement) {
                                                          ...
                                                          size_t maximumNumberOfRows )
    {
        ...
        {
            internal::throw_error( line.size( ) <= width, "Line is longer the width!" );
